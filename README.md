...
Note: You may notice that undo has additional steps from this script. That is normal. Basically, this script adds various custom actions and so only one additional action is added to your undo stack whenever you do the following:  
